...
public class TeleopCommand extends CommandBase {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=VARIABLE_DECLARATIONS
        ...
        private NetworkTableEntry controllerWidget;

    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS


    public TeleopCommand(Drive subsystem, SendableChooser<DriveOption> driveChooser) {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=VARIABLE_SETTING
        ...
        controllerWidget = Shuffleboard.getTab("Teleop").addPersistent("Controller", "Joysticks").getEntry();
    ...
    public void tankDriveExec() {
        ...
        if(enablePID.getBoolean(false)) {
            if(controllerWidget.getString("Joysticks") == "Joysticks"){
