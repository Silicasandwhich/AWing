        ...
        if (pathString == "none") {
            ...
            DifferentialDriveVoltageConstraint voltageConstraint = new DifferentialDriveVoltageConstraint(
                new SimpleMotorFeedforward(
                    ...
                    DriveConstants.kVC,
                    DriveConstants.kAC
                ), m_drive.getKinematics(), 10);
            
            TrajectoryConfig config = 
                new TrajectoryConfig(AutoConstants.kMaxSpeed,AutoConstants.kMaxAcceleration).setKinematics(m_drive.getKinematics()).addConstraint(voltageConstraint);
